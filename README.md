...
| 화면                    | 설명                                               | 이미지                |
| --------------------- | ------------------------------------------------ | ------------------ |
| **타이틀 화면**            | 앱 실행 시 첫 화면. 불꽃 연출과 로고가 강조됨                      | ![타이틀](캡처.PNG)     |
| **메인 모드 선택**          | 코어 트레이닝, 코어 게임, 3D 뷰어 모드 선택 가능                   | ![모드선택](1.PNG)     |
| **레벨 선택 화면**          | 초급/중급/고급 3단계 난이도 선택                              | ![레벨선택](7.PNG)     |
| **트레이닝 진행 화면**        | 실제 운동 영상을 기반으로 한 루틴 가이드                          | ![트레이닝](6.PNG)     |
| **3D 뷰어 모드**          | 운동 자세를 360도 회전·확대해 확인 가능                         | ![뷰어](8.PNG)       |
| **프로필/리포트 화면**        | 운동 기록, 달성 뱃지, 누적 시간 확인 가능                        | ![프로필](2.PNG)      |
| **게임 선택 화면**          | Tower Maker, Delivery Man, Wire Walking 3종 게임 선택 | ![게임선택](5.PNG)     |
| **게임 - Delivery Man** | 균형 유지 중심 게임. 좌우 움직임으로 성공/실패 판정                   | ![Delivery](0.jpg) |
| **게임 - Tower Maker**  | 블록을 쌓으며 균형을 유지하는 게임                              | ![Tower](3.PNG)    |
| **운동 시연 (플랭크)**       | 올바른 플랭크 자세 유지, 타이머와 함께 진행                        | ![플랭크](9.PNG)      |
| **운동 시연 (버드독)**       | Bird Dog 자세 3D 모델링으로 단계별 확인                      | ![버드독](10.jpg)     |
