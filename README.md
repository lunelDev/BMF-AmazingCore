...
| **트레이닝 진행 화면**        | 실제 운동 영상을 기반으로 한 루틴 가이드                          | ![트레이닝](Screenshots/6.PNG)     |
...
| **운동 시연 (플랭크)**       | 올바른 플랭크 자세 유지, 타이머와 함께 진행                        | ![플랭크](Screenshots/9.PNG)      |
| **운동 시연 (버드독)**       | Bird Dog 자세 3D 모델링으로 단계별 확인                      | ![버드독](Screenshots/10.jpg)     |
